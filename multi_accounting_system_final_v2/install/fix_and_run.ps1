...
New-Item -ItemType Directory -Path "C:\Users\roozbeh\Desktop\scripts_package\multi_accounting_system_final_v2\logs" -Force
...
pip install -r "C:\Users\roozbeh\Desktop\scripts_package\multi_accounting_system_final_v2\requirements.txt" --force-reinstall
...
docker-compose -f "C:\Users\roozbeh\Desktop\scripts_package\multi_accounting_system_final_v2\docker\docker-compose.yml" up -d

# Run Bot
Write-Host "Running the bot..."
python "C:\Users\roozbeh\Desktop\scripts_package\multi_accounting_system_final_v2\scripts\run_bot.py"
